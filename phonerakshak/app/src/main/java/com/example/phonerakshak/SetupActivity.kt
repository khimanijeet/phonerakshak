...
class SetupActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.switchBootRecovery.isChecked = prefs.bootRecoveryEnabled
        binding.switchBootRecovery.setOnCheckedChangeListener { _, checked ->
            prefs.bootRecoveryEnabled = checked
            toast(if (checked) "Boot recovery ON" else "Boot recovery OFF")
        }
    ...
    private fun onSaveClicked() {
        ...
        prefs.bootRecoveryEnabled = binding.switchBootRecovery.isChecked
